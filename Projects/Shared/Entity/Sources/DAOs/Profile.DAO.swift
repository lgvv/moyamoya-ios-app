...
extension DAO {
    public struct Profile: Codable, Hashable {
        ...
        public init(userId: String, userCode: String, userNickname: String, majors: [Major], clubs: [Club], mbti: String, bloodType: String, subwayInfos: [SubwayInfo], viewerShip: String, createAt: Foundation.Date = Date.now) {
            self.userId = userId
