...
public struct FunchTextField: View {
    ...
    public init(
        ...
        backgroundColor: Color = DesignSystemAsset.Color.gray800.swiftUIColor,
        textLimit: Int? = nil,
    ...
    private var borderColor: Color {
        if isError { return DesignSystemAsset.Color.coral500.swiftUIColor }
        else if !isFocused { return DesignSystemAsset.Color.gray800.swiftUIColor }
        else { return .white }
    }
    /// text의 개수를 세는 부분의 색상
    private var textCountColor: Color {
        ...
        else { return DesignSystemAsset.Color.gray400.swiftUIColor }
    }
    /// text의 개수 제한 부분의 색상
    ...
    private var textField: some View {
        TextField(
            "",
            text: $text,
            prompt: Text(placeholderText).foregroundColor(DesignSystemAsset.Color.gray400.swiftUIColor)
        )
        .autocorrectionDisabled()
        .focused($isFocused)
    ...
    private var leadingView: some View {
        ...
        case .icon:
            leadingImage?
                .resizable()
                .foregroundColor(DesignSystemAsset.Color.gray500.swiftUIColor)
    ...
    private var trailingView: some View {
        ...
        case .button:
            Button {
                ...
                trailingButtonImage?
                    .resizable()
                    .foregroundColor(DesignSystemAsset.Color.yellow500.swiftUIColor)
                    .frame(width: 24, height: 24)
                    .padding(8)
